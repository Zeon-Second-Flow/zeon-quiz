...
export const LeaderboardPage = () => {
    ...
    const sortUsers = (str: string) => {
        setSortBy(str);
        setUsers(users.sort((a, b) => str === "Points" ? b.overall_score - a.overall_score : b.passed_tests - a.passed_tests));
                    ...
                    <div className="sort">
                        ...
                        <form className="tabContents">
                            <li className="tab bedwars active">
                                <input defaultChecked={true} name="sort" id="q" type="radio" value="Points"/>
                                <label onClick={() => sortUsers("Points")}
                                    htmlFor="q">Points</label>
                                <input
                                    name="sort" id="w" type="radio" value="Games Played"/>
                                <label onClick={() => sortUsers("Game")} htmlFor="w">Games Played</label>
                            </li>
                        </form>
                    </div>
                </div>
